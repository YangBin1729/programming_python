...
class Hello(GuiMixin, GuiMakerWindowMenu):
    def start(self):
        ...
        self.menuBar = [('File', 0, [('New...', 0, spawnme),
                        ...
                        ('Play', 0, [('Hello', 0, self.greeting),
                                     ('Popup...', 0, self.dialog),
                                     ('Demos', 0, [('Toplevels', 0, lambda:self.spawn(r'.\toplevel2.py')),
                                                   ('Frames', 0, lambda:self.spawn(r'.\demoAll-frm.py')),
                                                   ('Images', 0, lambda:self.spawn(r'.\buttonpics.py')),
                                                   ('Alarm', 0, lambda:self.spawn(r'.\alarm.py', wait=False)),
                                                   ('Other', 0, self.pickDemo)]
                                      )]
                         )]

        self.toolBar = [('Quit', self.quit, dict(side=RIGHT)),
